...
import pytest
from week03_water_flow import water_column_height, pressure_gain_from_water_height, pressure_loss_from_pipe, pressure_loss_from_fittings, reynolds_number, pressure_loss_from_pipe_reduction, kpa_to_psi
...
def test_test_pressure_loss_from_pipe():
...
def test_kpa_to_psi():
    assert kpa_to_psi(100) == approx(14.5038)
    assert kpa_to_psi(50) == approx(7.2519)
